...
amtCornellUniversity = new.count('CornellUniversity')
amtNortheasternUniversity = new.count('NortheasternUniversity')

#makes a list of the number of times each college was chosen
newlist =[]
newlist.append(amtCornellUniversity)
newlist.append(amtNortheasternUniversity)
...
collegelist = ['Cornell University', 'Northeastern University']
college = collegelist[collegelistnumber]

#list of links for the college received
link = ["https://www.cornell.edu/", "http://www.northeastern.edu/"]
...
<center>
	...
	<table class="major"> 
		<tr>
			<td> <center> <h2> It looks like you will be studying </h2> <h1> Sciences </h1> 
