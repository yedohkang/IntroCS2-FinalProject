...
amtHarvardUniversity = new.count('HarvardUniversity') 
amtNewYorkUniversity = new.count('NewYorkUniversity')

#makes a list of the number of times each college was chosen
newlist =[]
newlist.append(amtHarvardUniversity)
newlist.append(amtNewYorkUniversity)
...
collegelist = ['Harvard University', 'New York University']
college = collegelist[collegelistnumber]

#list of links for the college received
link = ["http://www.harvard.edu/", "http://www.nyu.edu/"]
...
<center>
	...
	<table class="major"> 
		<tr>
			<td> <center> <h2> It looks like you will be studying </h2> <h1> Social Sciences </h1> 
