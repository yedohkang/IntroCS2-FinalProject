...
amtMassachusettsInstituteofTechnology = new.count('MassachusettsInstituteofTechnology')
amtRiceUniversity = new.count('RiceUniversity')

#makes a list of the number of times each college was chosen
newlist =[]
newlist.append(amtMassachusettsInstituteofTechnology)
newlist.append(amtRiceUniversity)
...
collegelist = ['Massachusetts Institute of Technology', 'Rice University']
college = collegelist[collegelistnumber]

#list of links for the college received
link = ["http://web.mit.edu/", "http://www.rice.edu/"]
...
<center>
	...
	<table class="major"> 
		<tr>
			<td> <center> <h2> It looks like you will be studying </h2> <h1> Engineering </h1> 
